...
- `AGENTS.md`
- `.opencode/instructions/READ-GRAPH-FIRST.md`
- `.opencode/memory/DECISIONS.md`

---

### 2. Initialize Repository Understanding
...
`create-user-story-audit architecture`

`create-user-story-audit security`

`create-user-story-audit backend`

`create-user-story-audit full`
