...
4. Confirm to the user with exactly this block: "US-$ARGUMENTS has been approved for implementation. To start the development phase, you MUST execute the following command: implement-user-story $ARGUMENTS"
